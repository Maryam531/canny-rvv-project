                               ...
                               int n)
{
 ...
 Direction* directions =   (Direction*)aligned_alloc( 64,(size_t)N * sizeof(Direction)); 
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // STAGE 1b: GAUSSIAN LMUL SWEEP (Phase 6, §6.2)
    //
    // Runs all three LMUL variants (1, 2, 4) back to back in this same
    // binary and prints a real sweep table. Each variant's output is also
    // checked against the scalar reference, since a faster-but-wrong
    // variant isn't useful data.
    // ═══════════════════════════════════════════════════════════════════════
    printf("==========================================================\n");
